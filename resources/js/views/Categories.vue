      ...
      <div class="d-block">
        <form v-on:submit.prevent="createCategory">
            ...
            <div class="form-group">
              ...
              <input type="file" v-on:change="attachImage" ref="newCategoryImage" class="form-control w-150px" id="image" />
      ...
      <div class="d-block">
        <form v-on:submit.prevent="updateCategory">
            ...
            <div class="form-group">
              ...
              <input type="file" v-on:change="editAttachImage" ref="editCategoryImage" class="form-control w-150px" id="image" />
              <div class="invalid-feedback" v-if="errors.image">{{errors.image[0]}}</div>
            </div>
            <hr>
            <div class="text-right">
...
<script>
  ...
  import * as categoriesService from '../services/category_service';
  ...
  export default {
    ...
    methods: {
      loadCategories: async function() {
        try {
         const response = await categoriesService.loadCategories();
      ...
      updateCategory: async function() {
        ...
        try {
          ...
          const response = await categoriesService.updateCategory(this.editCategoryData.id, formData);
