      ...
      <div class="d-block">
        <form v-on:submit.prevent="createProduct">
            ...
            <div class="form-group">
              ...
              <input type="file" v-on:change="attachImage" ref="newProductImage" class="form-control w-150px" id="image" />
      ...
      <div class="d-block">
        <form v-on:submit.prevent="updateProduct">
            ...
            <div class="form-group">
              ...
              <input type="file" v-on:change="editAttachImage" ref="editProductImage" class="form-control w-150px" id="image" />
              <div class="invalid-feedback" v-if="errors.image">{{errors.image[0]}}</div>
            </div>
            <hr>
            <div class="text-right">
  ...
  export default {
    ...
    methods: {
      ...
      loadCategories: async function() {
        try {
         const response = await productsService.loadCategories();
      ...
      updateProduct: async function() {
        ...
        try {
          ...
          const response = await productsService.updateProduct(this.editProductData.id, formData);
      ...
      loadMore: async function() {
        try {
          const response = await productsService.loadMore(this.nextpage);
          console.log(response);
